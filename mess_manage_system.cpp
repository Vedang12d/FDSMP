...
void mess::attendance()
{
    ...
    string name;
    cout << "Enter name for attendance->";
    cin >> name;
    while (p != NULL)
    {
        // cout<<"while";
...
void mess::receipt()
{
    ...
    while (temp != NULL)
    {
        if (temp->name == mname)
        {
            ...
            file << endl
                 << endl;
            file << " Signature of  customer"
                 << "                                     Signature of Manager" << endl;
    ...
    if (aid == id && apassword == password)
    {
        while (count == 1)
        {
            ...
            cout << "1:To Add new Customer\n"
                 << "2:To display customer info" << endl
                 << "3:To add attendance\n"
                 << "4:Receipt of Payment " << endl;
            cout << "5:To delete customer" << endl
                 << "6:Update information" << endl
                 << "7:Total" << endl
                 << "8:To stop\n";
            cin >> N;
            switch (N)
...
Enter name of Customer->Vedang
Enter phone number->8830536814
Enter the timing (1.lunch 2.dinner 3.both)1
Enter Date of joining mess->12/1/21
...
Enter name for attendance->Vedant
Enter Date->13/1/21
...
------------------------------------------------------------------------------
Sarvesh                7249363274        24/5/21            500

Date                     Lunch        Dinner


15/6/21                Present         Absent

------------------------------------------------------------------------------
Tejas              8421912954        21/3/21           1000

Date                     Lunch        Dinner


12/4/21                Present        Present
...
Vedang               8830536814        12/3/21            800              1              0            200
Vedant               9112844824        23/4/21            900              0              0            100
Sarvesh              7249363274        24/5/21            500              1              0           1500
Tejas                8421912954        21/3/21           1000              1              1           1000
*/
